    ...
    return (
      <View style={s.container}>
        <Image
          source={{
            uri:
              'https://upload.wikimedia.org/wikipedia/commons/thumb/3/3f/Commons-emblem-success.svg/1024px-Commons-emblem-success.svg.png',
          }}
        ...
        {Object.keys(CollectionType).map((item, index) => {
            return (
              <OrderDetails
                key={index}
                item={CollectionsStore.items[index]}
              />
            );
          })}
